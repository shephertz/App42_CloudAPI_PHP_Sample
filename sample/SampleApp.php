...
include_once '../lib/UserService.php'; 
include_once '../lib/App42Response.php';  
include_once '../lib/App42Log.php';
include_once '../lib/App42BadParameterException.php';
include_once '../lib/App42NotFoundException.php';
include_once '../lib/App42SecurityException.php';
include_once '../lib/App42Exception.php';
